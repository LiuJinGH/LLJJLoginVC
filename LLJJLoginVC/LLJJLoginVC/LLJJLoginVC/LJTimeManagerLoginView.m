...
- (UIView *)contentView {
	if(_contentView == nil) {
        ...
        LJSetViewCornerRadius(16, _contentView.layer);
...
- (UIView *)loginTextView {
    if(_loginTextView == nil) {
        ...
        LJSetViewCornerRadius(8, _loginTextView.layer);
        ...
        LJSetViewCornerRadius(8, btnView.layer);
...
- (UIColor *)viewColor {
	if(_viewColor == nil) {
		_viewColor = [UIColor colorWithRed:RGB_FLOAT(54) green:RGB_FLOAT(172) blue:RGB_FLOAT(255) alpha:1.0];
	}
	return _viewColor;
}
